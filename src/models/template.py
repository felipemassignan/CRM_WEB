...
class Template(db.Model):
    ...
    category = db.Column(db.String(50), nullable=False)  # ConexÃ£o LinkedIn, Primeira Mensagem, Follow-up, etc.
    ...
    variables = db.Column(db.String(255))  # Lista de variÃ¡veis utilizadas
